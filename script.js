                ...
                $.ajax({
                    ...
                    success: function (data1) {
                        ...
                        if (data1.res == 1) {
                            ...
                            //   Построение графика D3JS  Horizontal Dynamic
                            ...
                            // 				keys: selectedIds.map(function (selectedId) {
                            ...
                            const connectGraph = $('rect.data-chart title').each(function () {
                                console.log($('rect.data-chart title').html())
                            })
                            console.log(connectGraph)


                            d3.selectAll(".legend-buttons").on("click", function (event) {
                            ...
                            // $('.rotate').toggle(function () { // Очистка старого графика
